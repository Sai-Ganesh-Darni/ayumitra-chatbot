    ...
    def determine_prakriti(bodyBuilt, joints, bodyOrgans, skin, hair, eyes, lips, teeth, initiation_capabilities, speech, memory, diseaseTendency, diseaseSuseptibility):
        ...
        info = {
                'vata': {
                    ...
                    eyes: ['dry', 'unsteady', 'moisturized', 'blinking', 'tired', 'teary', 'watery', 'irritated', 'itchy'],
                    lips: ['deep-colored', 'moisturized', 'intensely shaded', 'hydrated', 'shadowed', 'well-moisturized', 'dark', 'smooth', 'soft', 'richly pigmented', 'well-hydrated', 'dark-hued', 'nourished', 'deep-toned', 'properly moisturized', 'supple', 'dark-shaded', 'adequately moisturize', 'well-maintained', 'deeply tinted', 'kept moisturized'],
                    teeth: [
                                'small', 'straight', 'resilient',
                                'crooked', 'charming',
                                'easily cracked', 'maintain good oral hygiene',
                                'small and neat', 'slightly crooked',
                                'tiny', 'misaligned', 'susceptible to cracking',
                                'tiny but strong', 'compact', 'sturdy',
                    ...
                    initiation_capabilities: [
                                                'quick', 'responsive', 'enthusiastic',
                                                'quick thinking', 'responsiveness', 'enthusiasm',
                                                'decision-making', 'quick mindset', 'initiating style',
                                                'initiation of projects', 'effective initiation',
                                                'action', 'initiation of tasks', 'known for',
                                                'key to', 'forte', 'strengths', 'blend of',
                                                'always responsive', 'characterize'
                                            ],
                    speech:[
                                'chatty', 'verbose', 'loquacious', 'garrulous', 'communicative',
                                'voluble', 'effusive', 'expressive', 'articulate', 'outspoken',
                                'vocal', 'talky', 'gabby', 'effervescent', 'glib', 'chatterbox'
                            ],
                    memory:  [
                                'swift', 'rapid', 'prompt', 'nimble', 'speedily', 'efficient', 'quickly', 'agile',
                                'effortless', 'quick-witted', 'speedy', 'prompt', 'retaining', 'limited', 'poor',
                                'subpar', 'inadequate', 'weak', 'sustaining', 'deficient', 'insufficient', 'impaired',
                                'substandard', 'below-average', 'low', 'faulty', 'limited', 'inferior', 'unsatisfactory',
                                'suboptimal', 'unobtrusive', 'low-key', 'gentle', 'quiet', 'reserved', 'taciturn',
                                'retiring', 'introspective', 'muted', 'pensive', 'soft-spoken', 'hushed', 'demure',
                                'subdued', 'subtle', 'quiet', 'low-profile'
                            ],
                    diseaseTendency: ['easily'],
                    diseaseSuseptibility: [
                                'reduced', 'diminished', 'decreased', 'lower', 'weakened', 'subdued', 'lessened', 'lowered',
                                'limited', 'protection', 'resistance', 'demonstrate', 'exhibit', 'maintenance', 'immunity',
                                'defense', 'vulnerability', 'sedate', 'laid-back', 'methodical', 'careful', 'easygoing',
                                'strong', 'exceptional', 'remarkable', 'impressive', 'outstanding', 'top-notch', 'excellent',
                                'superior', 'good', 'high', 'effective', 'noteworthy', 'superb', 'robust', 'exemplary',
                                'high-level', 'notable']
                },
                'pitta': {
                    bodyBuilt: [
                    ...
                    eyes:  ['sharp', 'penetrating', 'blonde', 'intense', 'copper-toned', 'copper-colored'],
                    lips: ['plush', 'softly pink', 'velvety', 'subtle pink', 'tender', 'naturally pink', 'soft', 'delicately colored', 'pillowy', 'rosy', 'gentle', 'pinkish'],
                    teeth: [
                                'moderate size', 'pearly white', 'yellowish',
                                'healthy', 'subtly yellowish enamel',
                                'naturally yellowish', 'lightly yellowish', 'robust',
                                'neither too small nor too large', 'subtle yellowish tint',
                                'straight', 'soft yellowish glow',
                                'well-maintained', 'warm and friendly appearance',
                                'gentle yellowish tint', 'pleasantly yellowish',
                                'reflecting dental health', 'gives them character',
                                'radiant smile', 'slightly yellowish', 'exude a friendly charm',
                                'natural yellowish shade', 'unique appeal',
                                'adds warmth', 'mild yellowish tint', 'showcasing a healthy radiance'
                            ],
                    initiation_capabilities: [
                                                    'moderate', 'upon conviction', 'understanding',
                                                    'conviction-driven', 'moderation', 'balanced approach',
                                                    'thoughtful moderation', 'clear understanding',
                                                    'deep understanding', 'measured approach', 'context'
                                                ],
                    speech: [
                                'authoritative', 'contending debater', 'assertive', 'leadership approach',
                                'decisive', 'managerial approach', 'approachable', 'guidance', 'leadership roles',
                                'public speaking engagements', 'team leader', 'negotiations', 'professional collaborations',
                                'persuasive'
                            ],
                    memory:[
                            'balanced', 'middle-of-the-road', 'moderated', 'average', 'middling', 'intermediate',
                            'tempered', 'standard', 'moderate', 'proficient', 'regular', 'ordinary', 'median',
                ...
                'kapha': {
                    ...
                    eyes: [
                                'sparkling', 'expressive', 'radiant with thick eyelashes',
                                'captivating and alluring eyes', 'enchanting',
                                'lush with thick eyelashes', 'supple',
                                'mesmerizing and attractive eyes', 'long and voluminous eyelashes',
                                'magnetic', 'compelling', 'striking and enticing eyes', 'charming',
                                'full with voluminous eyelashes', 'hydrated',
                                'captivating and attractive eyes', 'dense eyelashes',
                                'hypnotic', 'appealing', 'alluring and enchanting eyes', 'bewitching'
                            ],
                    lips:  ['full', 'naturally pink', 'thick', 'moist', 'pillowy', 'pinkish', 'plush','oily'],
                    teeth: [
                                'strong', 'large', 'radiantly white',
                                'robust', 'stunningly white', 'impeccably white',
                                'powerful', 'substantial size', 'gleaming white',
                                'sturdy', 'impressively large', 'brilliantly white',
                                'pearly white luster', 'strikingly white', 'straight',
                                'naturally strong', 'generously large', 'whiter than snow',
                                'dazzling white brilliance', 'teeth with great strength and size',
                                'purely white', 'healthy', 'impressive',
                                'blindingly white', 'well-maintained', 'resilient',
                                'sparkling white', 'flawlessly white', 'teeth of substantial size',
                                'exceptionally strong', 'dazzlingly white', 'pure white',
                                'considerable size', 'shining white'
                            ],
                    initiation_capabilities: [
                                    'slow', 'deliberate', 'steady', 'thorough',
                                    'methodical', 'intentionally slow', 'thoughtful',
                                    'comprehensive understanding', 'quality over speed'
                                ],
                    speech:   [
                                    'serene', 'tranquil', 'composed', 'placid', 'equanimous', 'unflappable', 'peaceful',
                                    'cool-headed', 'balanced', 'soothing', 'calm', 'reassuring', 'gentle', 'quiet',
                                    'unobtrusive', 'level-headed', 'equanimity', 'collected', 'measured', 'unperturbed',
                                    'reserved', 'taciturn', 'retiring', 'introspective', 'muted', 'low-key', 'pensive',
                                    'soft-spoken', 'hushed', 'demure', 'subdued', 'subtle', 'quiet', 'low-profile'
                                ],
                    memory:  [
                                'deliberate', 'gradual', 'leisurely', 'sluggish', 'tardy', 'prolonged', 'relaxed',
                                'languid', 'slow', 'moderate', 'measured', 'steady', 'sedate', 'unhurried', 'laid-back',
                                'methodical', 'careful', 'easygoing', 'strong', 'exceptional', 'remarkable', 'impressive',
                                'outstanding', 'top-notch', 'excellent', 'superior', 'good', 'high', 'effective',
                                'noteworthy', 'superb', 'robust', 'exemplary', 'high-level', 'notable'],
                    diseaseTendency: ['Good resistance'],
                    diseaseSuseptibility:  [
                                'significant', 'intensely', 'heightened', 'high', 'substantial', 'elevated', 
                                'increased', 'pronounced', 'extreme', 'intense'
                            ]
                }
            }
